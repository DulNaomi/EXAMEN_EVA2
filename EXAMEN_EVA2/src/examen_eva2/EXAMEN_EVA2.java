...
public class EXAMEN_EVA2 {
    ...
    public static void main(String[] args) {
        ...
        EmpleadoTiempoCompleto empleado1 = new EmpleadoTiempoCompleto("Maria", 3000);
        EmpleadoPorHora empleado2 = new EmpleadoPorHora(50, "Rodrigo", 3000);
        EmpleadosPorContrato empleado3 = new EmpleadosPorContrato("Pedro", 3000);  
